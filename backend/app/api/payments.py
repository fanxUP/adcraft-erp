...
async def download_project_cost_template(
    ...
    try:
        ...
        headers = ["分项", "成本日期", "成本摘要", "说明", "数量", "单位", "单价", "金额", "欠款金额", "备注", "成本类别", "付款方式", "收款公司"]
        col_widths = [20, 18, 30, 30, 12, 10, 12, 14, 14, 30, 18, 16, 22]
        ...
        example_data = ["灯箱制作", "2026-07-08", "灯箱制作成本摘要", "安装工人加班费", 2, "套", 250.00, 500.00, 0, "示例数据，可删除", "人工/工时费", "转账支付", "XX广告制作公司"]

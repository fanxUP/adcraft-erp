...
class VehicleUseRequest(Base, TimestampMixin):
    ...
    estimated_distance_km: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True, comment="预计里程(km)")
...
class VehicleDispatch(Base, TimestampMixin):
    ...
    start_mileage: Mapped[Decimal | None] = mapped_column(Numeric(12, 1), nullable=True, comment="出车里程(km)")
    end_mileage: Mapped[Decimal | None] = mapped_column(Numeric(12, 1), nullable=True, comment="收车里程(km)")
    actual_distance_km: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True, comment="实际行驶里程(km)")
...
class VehicleTripRecord(Base, TimestampMixin):
    ...
    start_mileage: Mapped[Decimal | None] = mapped_column(Numeric(12, 1), nullable=True, comment="出车里程")
    end_mileage: Mapped[Decimal | None] = mapped_column(Numeric(12, 1), nullable=True, comment="收车里程")
    distance_km: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True, comment="实际公里数")
...
class VehicleFuelRecord(Base, TimestampMixin):
    ...
    amount: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=0, nullable=False, comment="金额")
    liters: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True, comment="升数")
    unit_price: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True, comment="单价")
    gas_station: Mapped[str | None] = mapped_column(String(128), nullable=True, comment="加油站")
    mileage: Mapped[Decimal | None] = mapped_column(Numeric(12, 1), nullable=True, comment="当前里程")
...
class VehicleMaintenanceRecord(Base, TimestampMixin):
    ...
    amount: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=0, nullable=False, comment="金额")
    mileage: Mapped[Decimal | None] = mapped_column(Numeric(12, 1), nullable=True, comment="当前里程")
    next_maintenance_mileage: Mapped[Decimal | None] = mapped_column(Numeric(12, 1), nullable=True, comment="下次保养里程")
...
class VehicleIncident(Base, TimestampMixin):
    ...
    fine_amount: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=0, nullable=False, comment="罚款金额")
    points_deducted: Mapped[int] = mapped_column(Integer, default=0, nullable=False, comment="扣分")
    repair_amount: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=0, nullable=False, comment="维修金额")
...
class VehicleAgentDraft(Base, TimestampMixin):
    ...
    confidence: Mapped[Decimal] = mapped_column(Numeric(4, 2), default=0, nullable=False, comment="置信度 0.00-1.00")
...
class VehicleAttachment(Base):
    """公司车辆档案附件（行驶证/登记证/保险单/年检/保养记录等）"""
    __tablename__ = "vehicle_attachments"

    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    vehicle_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("vehicles.id"), nullable=False, comment="关联车辆")
    ...
    __table_args__ = (
        Index("ix_vehicle_attachments_vehicle_id", "vehicle_id"),
    )

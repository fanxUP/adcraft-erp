...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'orders/recycle', name: 'OrderRecycle', component: () => import('@/views/orders/OrderRecycle.vue') },
      ...
      { path: 'suppliers', name: 'SupplierList', component: () => import('@/views/suppliers/SupplierList.vue') },
      ...
      { path: 'outsource/tasks/recycle', name: 'OutsourceTaskRecycle', component: () => import('@/views/outsource/OutsourceTaskRecycle.vue') },
      ...
      { path: 'backups', name: 'BackupManage', component: () => import('@/views/system/BackupManage.vue') },
      ...
      { path: 'admin/users', name: 'AdminUserManage', component: () => import('@/views/admin/UserManage.vue') },
      { path: 'admin/roles', name: 'AdminRoleManage', component: () => import('@/views/admin/RoleManage.vue') },
      { path: 'admin/settings', name: 'AdminSettings', component: () => import('@/views/admin/SystemSettings.vue') },
      { path: 'admin/ai/providers', name: 'AIProviderList',
            component: () => import('@/views/ai-model-center/ProviderList.vue') },
            { path: "employees", name: "EmployeeList", component: () => import("@/views/employee/EmployeeList.vue") },
            { path: "departments", name: "DepartmentList", component: () => import("@/views/employee/DepartmentList.vue") },
            { path: "salaries", name: "SalaryList", component: () => import("@/views/employee/SalaryList.vue") },
            { path: "salary-report", name: "SalaryReport", component: () => import("@/views/employee/SalaryReport.vue") },
            { path: "salary-rules", name: "SalaryRuleList", component: () => import("@/views/employee/SalaryRuleList.vue") },
            { path: "employment-histories", name: "EmploymentHistoryList", component: () => import("@/views/employee/EmploymentHistoryList.vue") },
            { path: "leaves", name: "LeaveRequestList", component: () => import("@/views/employee/LeaveRequestList.vue") },
      { path: "attendance/records", name: "AttendanceRecordList", component: () => import("@/views/attendance/AttendanceRecordList.vue") },
      { path: "attendance/rules", name: "AttendanceRuleList", component: () => import("@/views/attendance/AttendanceRuleList.vue") },
      { path: 'admin/ai/knowledge-health', name: 'AIKnowledgeHealth',

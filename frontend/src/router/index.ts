...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'material-process', name: 'MaterialProcessManage', component: () => import('@/views/material-process/MaterialProcessManage.vue') },
      { path: 'materials', redirect: '/material-process' },
      { path: 'processes', redirect: '/material-process' },
      ...
      { path: 'framework-contracts', name: 'FrameworkContractList', component: () => import('@/views/contracts/FrameworkContractList.vue') },
      { path: 'framework-contracts/:id', name: 'FrameworkContractDetail', component: () => import('@/views/contracts/FrameworkContractDetail.vue') },
      ...
      { path: 'aerial-driver-expenses', name: 'AerialDriverExpenseList', component: () => import('@/views/aerial/AerialDriverExpenseList.vue') },
      { path: 'aerial-driver-wages', name: 'AerialDriverWageList', component: () => import('@/views/aerial/AerialDriverWageList.vue') },
      ...
      { path: 'aerial-drivers', name: 'AerialDriverList', component: () => import('@/views/aerial/AerialDriverList.vue') },

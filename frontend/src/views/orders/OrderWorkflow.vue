<template>
  <div class="ow-bar">
    ...
    <div v-if="progressVisible" class="ow-progress">
      ...
      <el-button v-if="currentStatus === 'confirmed'" size="small" :loading="changing" @click="emit('change', 'designing')">推进到设计</el-button>
    </div>
  </div>
...
.card-disabled .ow-label { color: var(--ad-text-secondary); }

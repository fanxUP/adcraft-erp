...
export const ACCESS_ROLES: Record<AccessKey, AccessRoles> = {
  ...
  orderRead: ['admin', 'sales', 'finance', 'manager'],
  ...
  designRead: ['admin', 'sales', 'designer', 'production', 'installer', 'manager'],
  designListRead: ['admin', 'sales'],
  production: ['admin', 'production'],
  productionRead: ['admin', 'sales', 'designer', 'production', 'installer', 'manager'],
  productionListRead: ['admin', 'sales'],
  installation: ['admin', 'installer'],
  installationRead: ['admin', 'sales', 'designer', 'production', 'installer', 'manager'],
